	...
	<div class="container">
		<div class="row">
			...
			<form method="post" action="replyAction.jsp?bbsID=<%= bbsID %>">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd"> <!-- 홀짝 행 구분 -->
					<thead>
						<tr>
					...
					<tbody>
						<%
							...
							ArrayList<Rep> list = repDAO.getList(bbsID, pageNumber);
						...
						%>
						<td><textarea type="text" class="form-control" placeholder="댓글을 입력하세요" name="replyContent" maxlength="2048"></textarea></td>
						<td sytle="text-align: left;"></td>
					</tbody>
				</table>
			...
			<!-- 해당 글의 작성자가 본인이라면 삭제와 수정이 가능하도록 코드 추가 -->
			<%
